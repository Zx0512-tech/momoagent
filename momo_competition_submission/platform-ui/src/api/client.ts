...
const MOCK_CAPABILITIES: CapabilityCatalog = {
  version: "1.0.0",
  data: ["ANALYSIS", "DAMPER_COMPARISON", "DAMPER_PARAMETER_SWEEP", "DAMPER_OPTIMIZATION", "FULL_OPTIMIZATION", "RESULT_INQUIRY", "SOLVER_BATCH", "RESULT_EXTRACTION", "EXPERIMENT_DESIGN", "SURROGATE_TRAINING", "ACTIVE_LEARNING", "MULTI_OBJECTIVE_OPTIMIZATION", "ENTROPY_TOPSIS_DECISION", "OPTIMIZATION_EXPORT"].map(jobType => ({
    jobType,
    mode: "MOCK",
    status: "MOCK_ONLY",
    handler: "mockDb",
