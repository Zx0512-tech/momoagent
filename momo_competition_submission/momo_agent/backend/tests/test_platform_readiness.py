...
def test_windows_launchers_parse_in_legacy_shells() -> None:
    ...
    batch_path = submission_root.parent / "momo.cmd"
    powershell_path = submission_root / "start.ps1"
    attributes_path = submission_root.parent / ".gitattributes"
    ...
    assert "/momo_competition_submission/start.ps1 text eol=crlf" in attributes
